...
public class AccountController {
    ...
    public AccountResponse credit(@PathVariable UUID accountId, @Valid @RequestBody AmountRequest request) {
        return accountService.credit(accountId, request.amount());
    }

    @PostMapping("/{accountId}/debit")
    public AccountResponse debit(@PathVariable UUID accountId, @Valid @RequestBody AmountRequest request) {
        return accountService.debit(accountId, request.amount());
    }
}
